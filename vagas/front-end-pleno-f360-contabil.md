...
- Conhecimento de frameworks como Vue.js, React, Angular, Knockout ou outros. Utilizamos no dia-a-dia o Vue.js nas plataformas novas e o Knockout nas plataformas antigas
...
- Ter conhecimento de ferramentas de edição de imagem pode ser interessante, mas não é um requisito obrigatório
...
2. Caso possua, encaminhe também seu portfólio com seus principais trabalhos de front-end (preferencialmente com o código fonte disponíve no GitHub);
